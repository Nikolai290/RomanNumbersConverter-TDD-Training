...
namespace RomanNumbersLibraryTests {
    public class ToRomanNumbersTests {
        public static IEnumerable<object[]> ToRomanNumbersTests_Data = new List<object[]>() {
            new object[] {1, "I"},
            new object[] {2, "II"},
            new object[] {3, "III"},
            new object[] {4, "IV"},
